package top.imcoco.javamavenjunithelloworld;
/**
...
public class HelloApp {
    static private int DEFAULT_TIME = 3;

    static private int EXIT_STATUS_PARAMETER_NOT_UNDERSTOOD = 2;
